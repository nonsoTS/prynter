    ...
    <div className="min-h-screen p-8">
      ...
      <div className="max-w-7xl mx-auto mb-12">
        ...
        <p className="text-3xl lg:text-6xl font-bold lg:font-semibold text-center mb-4">
          360 Printing & Branding<br />Solutions Tailored For You.
        </p>
      ...
      <div className="mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="flex flex-col justify-between items-stretch bg-[#E5E5E5] rounded-3xl p-4 shadow-sm">
          <div>
            ...
            <p className="text-xl font-bold mb-2">Print and Production Services</p>
          ...
          <div className="space-y-3 mt-6">
            <div className="bg-gray-50 rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1">Marketing & Corporate Assets</p>
            ...
            <div className="bg-black rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1 text-white">Large format & Outdoor Branding</p>
            ...
            <div className="bg-gray-50 rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1">Packaging & Custom Print</p>
                  <p className="text-[10px] text-[#343330C7] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
        ...
        <div className="flex flex-col justify-between items-stretch bg-[#E5E5E5] rounded-3xl p-4 shadow-sm">
          <div>
            ...
            <p className="text-xl font-bold mb-2">Events, Campaigns and Branding</p>
            <p className="text-gray-600 mb-6">
              Transforming spaces, stages, and stories into unforgettable branded moments
            </p>
          </div>
          ...
          <div className="space-y-3 mt-6">
            <div className="bg-gray-50 rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1">Event Brand Production</p>
                  <p className="text-[10px] text-[#343330C7] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
            ...
            <div className="bg-black rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1 text-white">Corporate & Campaign Activations</p>
                  <p className="text-[10px] text-[#D9D9D9EB] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
            ...
            <div className="bg-gray-50 rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1">Promotional & Launch Materials</p>
                  <p className="text-[10px] text-[#343330C7] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
        ...
        <div className="flex flex-col justify-between items-stretch bg-[#E5E5E5] rounded-3xl p-4 shadow-sm">
          <div>
            ...
            <p className="text-xl font-bold mb-2">Custom Merch, Apparel and Swags</p>
            <p className="text-gray-600 mb-6">
              Premium merchandise designed to make teams, customers, and communities feel connected.
            </p>
          </div>
          ...
          <div className="self-end space-y-3 mt-6">
            <div className="bg-gray-50 rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1">Apparel & Wearables</p>
                  <p className="text-[10px] text-[#343330C7] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
            ...
            <div className="bg-black rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1 text-white">Corporate & PR Gifts</p>
                  <p className="text-[10px] text-[#D9D9D9EB] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
            ...
            <div className="bg-gray-50 rounded-full p-2 flex items-center justify-between">
              <div className="w-full flex flex-row justify-between items-center gap-x-1">
                ...
                <div>
                  <p className="font-medium text-[12px] mb-1">Full Swag Box Production</p>
                  <p className="text-[10px] text-[#343330C7] flex items-center gap-1">
                    <span className="w-2 h-2 bg-red-500 rounded-full shrink-0"></span>
                    Onboarding boxes, event packs, investor kits, team merch bundles
                  </p>
                </div>
                <div className="flex flex-row justify-center items-center w-12 h-12 bg-gray-300 rounded-full p-2 shrink-0">
                  <Shirt color={"#FF3700"} className='m-0' />
